  ...
  return (
    <HeroHighlight>
      <motion.h1
        ...
        className={`text-4xl px-4 lg:text-7xl font-bold text-white max-w-4xl leading-relaxed lg:leading-snug text-center mx-auto md:mt-20`}
      >
        Create amazing content <br /> with
        <Highlight className="text-white ml-2 md:ml-4">AI tools</Highlight>
      </motion.h1>
      <p className="text-white mt-4 max-w-xs sm:max-w-sm xl:max-w-2xl m-auto max-sm:text-sm text-xl text-center font-semibold">
