  ...
  return (
    ...
    >
      ...
      {user ? (
        ...
        <button
          onClick={openSignIn}
          className="ml-auto bg-white relative z-10 hover:shadow-[0px_0px_30px_14px] shadow-[0px_0px_30px_7px] hover:shadow-white/50 shadow-white/50 text-black px-4 py-2 rounded-full text-sm font-medium hover:bg-slate-100 transition duration-300"
        >
          Get Started
        </button>
      )}

      {/* <button id="menuToggle" className="hidden text-gray-600">
        <svg
          className="w-6 h-6"
          fill="none"
          stroke="currentColor"
